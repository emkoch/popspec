...
void sim_batch(int N_sims, 
    ...
    for (int i = 0; i < N_sims; ++i) {
        ...
        simulate_population(N, theta, rho, run_mult, beta_1, beta_2, pop, i, slurm_seed, underdominant);
...
int main(int argc, char *argv[]) {
    ...
    sim_batch(N_sims, N, theta, rho, run_mult, eff_size_float_1, eff_size_float_2, symm_param, slurm_seed, underdominant);
